/*
SoftSerialTx.cpp (based on SoftwareSerial) -
Multi-instance software transmit-only serial library for Arduino/Wiring
...
// Statics
//
SoftSerialTx *SoftSerialTx::active_object = 0;
...
// Constructor
//
SoftSerialTx::SoftSerialTx(uint8_t transmitPin, bool inverse_logic /* = false */) :
  _tx_delay(0),
...
size_t SoftSerialTx::write(uint8_t b)
{
  if (_tx_delay == 0) {
    setWriteError();
    return 0;
